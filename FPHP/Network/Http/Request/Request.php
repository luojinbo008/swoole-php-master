...
use FPHP\Util\Types\Str;
use FPHP\Contract\Foundation\Arrayable;
use FPHP\Network\Http\Bag\ParameterBag;
use FPHP\Contract\Network\Request as RequestInterface;

class Request extends BaseRequest implements Arrayable, RequestInterface
{
    /**
     ...
     *
     * @return \FPHP\Network\Http\Bag\ParameterBag
     */
